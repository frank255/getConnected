...
function Index() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(HelmetExport, null, /* @__PURE__ */ React.createElement("title", null, "Home - getConnected"), /* @__PURE__ */ React.createElement("meta", {
    ...
    className: "md:mt-6 md:ml-36 flex items-center"
  }, /* @__PURE__ */ React.createElement(Link, {
    to: "services"
  }, /* @__PURE__ */ React.createElement("button", {
    className: "hover:bg-orange-200 flex bg-green-400 text-lg p-2 ml-8 md:text-xl md:px-8 md:py-3 rounded-md skew-x-6"
...
//# sourceMappingURL=/build/routes/index-VNTPLYAR.js.map
