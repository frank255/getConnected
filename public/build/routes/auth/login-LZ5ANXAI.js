...
function index() {
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("div", {
  ...
  }, "Login to Continue \u{1F60A}"), /* @__PURE__ */ import_react.default.createElement("p", {
    className: "pt-2 pb-4"
  }, "You may signin using links below......."), /* @__PURE__ */ import_react.default.createElement("div", {
  ...
  }, "Not registered? click the button below to sign up"), /* @__PURE__ */ import_react.default.createElement("div", {
    ...
    className: "p-1"
  }, /* @__PURE__ */ import_react.default.createElement(FaUserPlus, null)), "Signup"))), /* @__PURE__ */ import_react.default.createElement("div", {
    class: "md:flex hidden flex-row items-center justify-start lg:justify-start mt-"
  }, /* @__PURE__ */ import_react.default.createElement("button", {
    type: "button",
    "data-mdb-ripple": "true",
    "data-mdb-ripple-color": "light",
    ...
    type: "button",
    className: "self-center flex px-8 py-3 text-lg rounded-full focus:ring hover:ring focus:ring-opacity-75 dark:bg-green-400 dark:text-gray-900"
  }, "Signin")))))), /* @__PURE__ */ import_react.default.createElement(Footer_default, null));
}
export {
  index as default
};
//# sourceMappingURL=/build/routes/auth/login-LZ5ANXAI.js.map
