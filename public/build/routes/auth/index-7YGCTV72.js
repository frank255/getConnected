...
function index() {
  return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, /* @__PURE__ */ import_react3.default.createElement("div", {
    ...
    className: "font-semibold border-2 border-green-400 rounded-full inline-block px-12 py-2 mt-6 hover:bg-green-400 hover:text-black"
    ...
    className: "font-semibold border-2 border-orange-400 rounded-full inline-block px-12 py-2 hover:bg-green-400 hover:text-black"
  }, "Sign Up"))))), /* @__PURE__ */ import_react3.default.createElement(Outlet, null)));
}
export {
  index as default
};
//# sourceMappingURL=/build/routes/auth/index-7YGCTV72.js.map
