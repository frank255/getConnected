...
function index() {
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("div", {
    ...
    type: "button",
    className: "self-center flex px-8 py-3 text-lg rounded-full focus:ring hover:ring focus:ring-opacity-75 dark:bg-orange-300 dark:text-gray-900"
...
//# sourceMappingURL=/build/routes/auth/register-4VW2CSJV.js.map
