...
function Navbar() {
  return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, /* @__PURE__ */ import_react3.default.createElement("header", {
    ...
    href: "",
    className: "text-xl font-semibold mx-[0.8rem] px-[0.8rem] py-[0.4rem] rounded-[0.8rem] bg-transparent hover:bg-orange-500 active:text-yello"
...
//# sourceMappingURL=/build/routes/index-VMLVBFGE.js.map
