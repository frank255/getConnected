...
function Index() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(HelmetExport, null, /* @__PURE__ */ React.createElement("title", null, "Home - getConnected"), /* @__PURE__ */ React.createElement("meta", {
    ...
    className: "md:px-4 md:py-4 my-10 bg-gray-100 "
    ...
    className: " md:pt-1 md:flex w-screen  md:flex-1 bg-gray-100 md:pb-20 "
  }, /* @__PURE__ */ React.createElement("div", {
    className: " md:w-1/2 grid md:h-52  justify-items-center text-black mx-4"
  }, /* @__PURE__ */ React.createElement("div", {
    className: "md:my-2 text-4xl md:text-6xl"
  }, "we connect you to the"), /* @__PURE__ */ React.createElement("div", {
    className: "md:mt-1 text-2xl md:text-5xl text-orange-300"
  }, "World of Opportunities!"), /* @__PURE__ */ React.createElement("div", {
    className: "flex m-6 justify-center w-1/2"
  }, /* @__PURE__ */ React.createElement("img", {
    className: "object-fit",
    src: "world.png",
    alt: "world image"
  })), /* @__PURE__ */ React.createElement("div", {
    className: "md:mt-10 grid justify-items-center text-black text-l"
...
//# sourceMappingURL=/build/routes/index-FZPPJVXF.js.map
