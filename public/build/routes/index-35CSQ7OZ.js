...
function Footer() {
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("footer", {
    className: "flex flex-col bg-gray-800 px-6 py-6  text-white items-center overflow-hidden  bottom-0 w-full mt-0 sm:hidden md:block"
    ...
    className: "flex flex-row justify-between md:hidden bottom-0"
...
//# sourceMappingURL=/build/routes/index-35CSQ7OZ.js.map
