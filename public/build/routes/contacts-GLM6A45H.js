...
function contact() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", {
    ...
    type: "button",
    className: "self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 dark:bg-green-400 dark:text-gray-900 focus:ring-violet-400 hover:ring-violet-400"
...
//# sourceMappingURL=/build/routes/contacts-GLM6A45H.js.map
