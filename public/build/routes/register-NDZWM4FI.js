...
function register() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Navbar_default, null), /* @__PURE__ */ React.createElement("section", {
    className: "flex flex-1 py-6 px-6 md:flex-row md:px-18 md:py-20 md:mx-20 md:shadow-md overflow-hidden"
...
//# sourceMappingURL=/build/routes/register-NDZWM4FI.js.map
