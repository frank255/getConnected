...
init_react();
function index() {
  fetch("http://localhost:1337/api/services").then((res) => res.json()).return(/* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", {
...
//# sourceMappingURL=/build/routes/services/index-BNGBEEQV.js.map
