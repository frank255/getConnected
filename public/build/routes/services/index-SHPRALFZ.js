...
function index() {
  ...
  }, "Check out our list of awesome services below."), services.map((service) => /* @__PURE__ */ React.createElement("div", {
    key: service.id,
    class: "grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0"
  }, 'console.log("services");', /* @__PURE__ */ React.createElement("div", {
  ...
  }, service.attributes.icon), /* @__PURE__ */ React.createElement("h4", {
...
//# sourceMappingURL=/build/routes/services/index-SHPRALFZ.js.map
