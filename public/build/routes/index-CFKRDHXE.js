...
function Index() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(HelmetExport, null, /* @__PURE__ */ React.createElement("title", null, "Home - getConnected"), /* @__PURE__ */ React.createElement("meta", {
    ...
    className: "hover:bg-orange-200 flex bg-green-400 text-lg p-3 rounded-full md:text-xl md:px-8 md:py-3 md:shadow-md md:skew-y-6 md:skew-x-6"
...
//# sourceMappingURL=/build/routes/index-CFKRDHXE.js.map
