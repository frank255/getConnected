...
function register() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Navbar_default, null), /* @__PURE__ */ React.createElement("section", {
    className: "flex flex-col md:flex-row px-18 py-20 mx-20 shadow-md overflow-hidden"
  }, /* @__PURE__ */ React.createElement("div", {
    className: " md:basis-3/4 px-20  ml-20 "
  }, /* @__PURE__ */ React.createElement("div", {
    className: "sm:w-3/4 lg:w-5/12 mx-auto"
  }, /* @__PURE__ */ React.createElement("h1", {
    className: "text-3xl text-center"
  }, "Register Here")), /* @__PURE__ */ React.createElement("form", {
    class: "w-full max-w-lg px-6 py-6 ml-20"
  }, /* @__PURE__ */ React.createElement("div", {
    ...
    className: "basis-1/4 items-center hidden md:flex"
...
//# sourceMappingURL=/build/routes/register-WZMHGRAK.js.map
