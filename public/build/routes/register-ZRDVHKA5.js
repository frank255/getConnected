...
// browser-route-module:/Volumes/ROOT/learning/getConnected/app/routes/register.jsx?browser
init_react();
...
function register() {
  const [registerInput, setRegister] = (0, import_react.useState)({
    firstname: "",
    lastname: "",
    email: "",
    phone: "",
  ...
  const registerSubmit = (e) => {
    ...
    import_axios.default.get("/sanctum/csrf-cookie").then((response) => {
      import_axios.default.post(`/api/register`, data).then((res) => {
      });
    });
  };
...
//# sourceMappingURL=/build/routes/register-ZRDVHKA5.js.map
