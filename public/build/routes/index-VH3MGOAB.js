...
function Footer() {
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("footer", null));
}
...
function Hero() {
  return /* @__PURE__ */ import_react2.default.createElement(import_react2.default.Fragment, null, /* @__PURE__ */ import_react2.default.createElement("section", {
    className: "mx-auto p-4 container overflow-hidden"
  }, /* @__PURE__ */ import_react2.default.createElement("div", {
    className: "container \n    flex\n    flex-col\n    lg:flex-row\n    items-center\n    gap-12\n    lg:mt-18\n    mx-auto"
  }, /* @__PURE__ */ import_react2.default.createElement("div", {
    className: "flex flex-auto flex-col items-center lg:items-start  lg:mt-0 px-4 sm:mx-4"
  }, /* @__PURE__ */ import_react2.default.createElement("h2", {
    className: "text-black text-3xl mt-6 md:text-5xl text-center lg:items-start mb-6"
  }, "We Connect you to the World!"), /* @__PURE__ */ import_react2.default.createElement("p", {
    className: "text-lg text-center lg:items-start mx-auto py-4 px-4 justify-center"
    ...
    className: "flex justify-center flex-auto mb-10 md:mb-16 lg:mb-0 z-10 lg:mt-20 "
...
//# sourceMappingURL=/build/routes/index-VH3MGOAB.js.map
