...
function register() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Navbar_default, null), /* @__PURE__ */ React.createElement("section", {
    ...
    class: "w-full md:w-1/2 px-3 md:mb-6 mb-2 md:mb-0"
    ...
    class: "flex-1 bg-teal-900 hover:bg-blue-700 text-white font-bold mx-2 w-12 py-2 px-6  rounded focus:outline-none focus:shadow-outline",
    type: "button"
...
//# sourceMappingURL=/build/routes/register-OOSZTLHH.js.map
