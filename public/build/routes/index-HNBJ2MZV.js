...
function Navbar() {
  return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, /* @__PURE__ */ import_react3.default.createElement("header", {
    ...
    href: "",
    className: "text-xl font-semibold mx-[0.8rem] px-[0.8rem] py-[0.4rem] rounded-[0.8rem] bg-transparent hover:bg-orange-500 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 "
...
//# sourceMappingURL=/build/routes/index-HNBJ2MZV.js.map
